import argparse
parser = argparse.ArgumentParser(description='UCF-CRIME-DVS')
parser.add_argument('--device', type=int, default=0, help='GPU ID')
parser.add_argument('--lr', type=float, default=0.0001,help='learning rate (default: 0.0001)')
parser.add_argument('--model_name', default='MSF', help=' ')
...
parser.add_argument('--feature_size', type=int, default=256, help='size of feature (default: 2048)')
...
parser.add_argument('--dataset_name', type=str, default='UCF_Crime_DVS', help='')
parser.add_argument('--dataset_path', type=str, default='/home/qyb/dataset/Spikingformer_dataset/DVS128_based feature/dataset', help='path to dir contains anomaly datasets')
parser.add_argument('--feature_modal', type=str, default='feature_hardvs', help='features from different input, options contain rgb, flow , combine')
parser.add_argument('--max-seqlen', type=int, default=16, help='maximum sequence length during training (default: 750)')
parser.add_argument('--Lambda', type=str, default='1_80', help='')
parser.add_argument('--seed', type=int, default=1213, help='random seed (default: 1)')
parser.add_argument('--max_epoch', type=int, default=20, help='maximum iteration to train (default: 20)')
parser.add_argument('--feature_pretrain_model', type=str, default='Spikingformer', help='type of feature to be used I3D or C3D (default: I3D)')
